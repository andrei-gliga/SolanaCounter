...
declare_id!("63JyfFi3vHUKTgV7EJKZeWC4TDT9ioNZMh4gk5CfjkWz");
...
pub struct Initialize<'info> {
    ...
    #[account(
        ...
        seeds = [b"counter"], // seed for the PDA (Program Derived Address)
        bump // specifies we are using a bump seed for the PDA
    )]
